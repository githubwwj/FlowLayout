...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 可用大小
        int useSize = sizeWidth - getPaddingLeft() - getPaddingRight();
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (lineWidth + childWidth > useSize) {
        ...
        int finalWidth = modeWidth == MeasureSpec.EXACTLY ? sizeWidth : width + getPaddingLeft() + getPaddingRight();
        int finalHeight = modeHeight == MeasureSpec.EXACTLY ? sizeHeight : height + getPaddingTop() + getPaddingBottom();
        setMeasuredDimension(finalWidth, finalHeight);
        Log.d("FlowLayout", "onMeasure()-->finalWidth=" + finalWidth + ",finalHeight=" + finalHeight);
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int width = getWidth();
        int useWidth = width - getPaddingLeft() - getPaddingRight();
        ...
        for (int i = 0; i < cCount; i++) {
            ...
            if (childWidth + lineWidth + lp.leftMargin + lp.rightMargin > useWidth) {
